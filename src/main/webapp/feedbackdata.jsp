...
try
{
  ...
  <thead class="thead-dark">                      
    <tr>
      ...
      <th scope="col">FIRST_VISIT</th>
      <th scope="col">LIKELIHOOD_TO_RETURN</th>
	...
	while( rs.next())
	{
       ...
       <td><%out.print(rs.getInt("user_id"));%></td>
        <td><%out.print(rs.getString("user_name"));%></td>
         <td><%out.print(rs.getString("first_visit"));%></td>
          <td><%out.print(rs.getString("Likelihood_toreturn"));%></td>
          <td><%out.print(rs.getInt("feed_back"));%></td>
        </tr>
		  <%
