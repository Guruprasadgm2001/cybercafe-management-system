		...
		<div class="container">
			...
			<div id="navbarSupportedContent" class="collapse navbar-collapse">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="workerdashboard.jsp"
...
<div class="bg-light">
  ...
  <h3>BG MAKES</h3>
    <div class="row h-100 align-items-center py-5">
      ...
      <div class="col-lg-6 d-none d-lg-block"><img src="https://o.remove.bg/downloads/c09702c3-8372-4dd0-bf5c-c7eff26b0a6d/WhatsApp_Image_2023-01-25_at_10.42.10_PM-removebg-preview-removebg-preview.png" alt="" class="img-fluid"></div>
    </div>
  </div>
</div>
